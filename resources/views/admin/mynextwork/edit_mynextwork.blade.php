        ...
        <div class="main-body">
            <div class="page-wrapper">
                ...
                @endif
                 ...
                 <form action="{{ url('MyWork/update_MyWork/'.$edit_data->id) }}" method="post">
                    @csrf
                    <div class="form-group row">
                        <label for="noted_date" class="col-sm-2 col-form-label">Noted Date</label>
                        <div class="col-sm-10">
                            <input type="date" id="noted_date" name="noted_date" class="form-control form-control-normal" value="{{ $edit_data->noted_date }}">
                        </div>
                    </div>
